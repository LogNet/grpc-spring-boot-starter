...
[NOTE]
The release notes with compatibility matrix can be found link:ReleaseNotes.adoc[here]  https://github.com/LogNet/grpc-spring-boot-starter/blob/master/ReleaseNotes.adoc[here^]
