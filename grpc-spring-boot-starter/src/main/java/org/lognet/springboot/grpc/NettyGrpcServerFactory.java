...
public class NettyGrpcServerFactory implements GrpcServerFactory {
	...
	private final List<ServerServiceDefinition> services = new LinkedList<>();
	...
	public Server createServer() {
		...
		for (ServerServiceDefinition service : this.services) {
			logger.info("Registered gRPC service: " + service.getServiceDescriptor().getName());
